        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOutfitCategory = table.Column<bool>(type: "boolean", nullable: false),
                    IsItemCategory = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutfitTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutfitTemplates_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    IsOutfitTag = table.Column<bool>(type: "boolean", nullable: false),
                    IsItemTag = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutfitCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutfitCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OutfitCategories_Outfits_OutfitId",
                        column: x => x.OutfitId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryIdHint = table.Column<Guid>(type: "uuid", nullable: true),
                    XPosition = table.Column<double>(type: "double precision", nullable: false),
                    YPosition = table.Column<double>(type: "double precision", nullable: false),
                    Scale = table.Column<double>(type: "double precision", nullable: false),
                    Rotation = table.Column<double>(type: "double precision", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutfitTemplateItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutfitTemplateItems_Categories_CategoryIdHint",
                        column: x => x.CategoryIdHint,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_OutfitTemplateItems_OutfitTemplates_TemplateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutfitCategories_CategoryId",
                table: "OutfitCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OutfitCategories_OutfitId",
                table: "OutfitCategories",
                column: "OutfitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutfitTemplateItems_CategoryIdHint",
                table: "OutfitTemplateItems",
                column: "CategoryIdHint");

            migrationBuilder.CreateIndex(
                name: "IX_OutfitTemplateItems_TemplateId",
                table: "OutfitTemplateItems",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_OutfitTemplates_UserId",
